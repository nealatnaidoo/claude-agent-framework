...
if [ $ERRORS -eq 0 ]; then
    ...
    echo "  Open Claude Code in any project directory and you're ready to go."
    echo ""
    echo "  If you need a custom API key (e.g. for direct API access), set:"
    echo "    export ANTHROPIC_API_KEY=sk-ant-..."
    echo "  and add {\"apiKeyHelper\": \"env:ANTHROPIC_API_KEY\"} to ~/.claude/settings.json"
    echo ""
    echo "============================================================================"
    echo ""
else
